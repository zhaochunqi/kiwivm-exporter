...
func TestCollectorMetricsAndLabels(t *testing.T) {
	...
	want := []struct {
		...
		{"kiwivm_network_in_bytes", map[string]string{"hostname": "vps-test-1807892", "veid": "1807892"}, 86073344},
		{"kiwivm_network_out_bytes", map[string]string{"hostname": "vps-test-1807892", "veid": "1807892"}, 81572864},
		{"kiwivm_disk_read_bytes", map[string]string{"hostname": "vps-test-1807892", "veid": "1807892"}, 24576},
		{"kiwivm_disk_write_bytes", map[string]string{"hostname": "vps-test-1807892", "veid": "1807892"}, 5709824},
